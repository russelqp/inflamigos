...
$_URL_BASE="http://127.1.0.0/InflamigosHTML5/";
 ?>
<?php
...
<h4>Ver los otros inflables</h4>
    <ul>
    <li><?php echo '<a href="inflable.php?inflable=angry-box">'; ?><img src="inflables/thumbs/angry_box.jpg"  alt="angry-box" title="Angry Box" /></a></li>
    <li><?php echo '<a href="inflable.php?inflable=castillo-aventura">'; ?><img src="inflables/thumbs/caventura_thumb.png" alt="castillo_aventura_middle" title="Castillo Aventura"/></a></li>
    <li><?php echo '<a href="inflable.php?inflable=castillo-princess">'; ?><img src="inflables/thumbs/cprincess_thumb.png" alt="castillo_princess_middle" title="Castillo Princess"/></a></li>
    <li><?php echo '<a href="inflable.php?inflable=escaladora">'; ?><img src="inflables/thumbs/escaladora_thumb.png" alt="escaladora_middle" title="ver la Escaladora"/></a></li>
        <li><?php echo '<a href="inflable.php?inflable=resbaladilla-bob-esponja">'; ?><img src="inflables/thumbs/bobesponja_thumb.png" alt="bob-esponja-middle" title="Bob Esponja Resbaladilla" /></a></li>
  	<li><?php echo '<a href="inflable.php?inflable=arco-slide">'; ?><img src="inflables/thumbs/aslide_thumb.png" alt="arco_slide_middle" title="Arco Slide"/></a></li>
	<li><?php echo '<a href="inflable.php?inflable=ultra-cubo">'; ?><img src="inflables/thumbs/ucubo_thumb.png" alt="ultra_cubo_middle" title="Ultra Cubo"/></a></li>
    <li><?php echo '<a href="inflable.php?inflable=space-lab">'; ?><img src="inflables/thumbs/spacelab_thumb.png" alt="space-lab-middle" title="Space Lab" /></a></li>
    <li><?php echo '<a href="inflable.php?inflable=escaladrilo">'; ?><img src="inflables/thumbs/escaladrilo_thumb.png" alt="escaladrilo-middle" title="Escaladrilo" /></a></li>
    <li><?php echo '<a href="inflable.php?inflable=aventura-palmeras">'; ?><img src="inflables/thumbs/aventurapalmeras_thumb.png" alt="aventura-palmeras-middle" title="Aventura Palmeras" /></a></li>
    <li><?php echo '<a href="inflable.php?inflable=aqualand">'; ?><img src="inflables/thumbs/aqualand_thumb.png" alt="aqualand-middle" title="Aqualand" /></a></li>
    <li><?php echo '<a href="inflable.php?inflable=splash-pool">'; ?><img src="inflables/thumbs/splashpool_thumb.png" alt="splash-pool-middle" title="Splash Pool" /></a></li>
    </ul>
